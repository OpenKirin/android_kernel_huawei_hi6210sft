...
#define DSM_ISP22_GET_OTP_STATUS_ERROR_NO   (20635)
#define DSM_ISP22_DQBUF_TIMEOUT_ERROR_NO    (20636)
#define DSM_ISP22_K3_MCAM_CSI_ERROR_NO      (20637)
#define DSM_ISP22_K3_SCAM_CSI_ERROR_NO      (20638)
