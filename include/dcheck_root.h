...
#define ACT_MODEM_FW_NM      "modem_fw"    //used by HISI V8R5
#define ACT_MODEMIMG_NM      "modemimage"  //used by V8R2M
#define ACT_DTIMG_NM         "dtimage"  //used by HISI
#define ACT_MCUIMG_NM        "mcuimage"  //used by HISI
