...
static bool vpp_opened = false;//DTS2015071507006 modify by w00227189 20150718
...
static int vpp_suspend(struct platform_device *pdev,pm_message_t state){
    ...
    //DTS2015071507006 modify by w00227189 20150718 begin
    if (vpp_opened == false)
    {
    ...
    regulator_bulk_disable(1, &vpp_regulator);
    //DTS2015071507006 modify by w00227189 20150718 end
...
*/
    ...
    hal_set_int_enable(HAL_INTMSK_VTEINT);
    s_vpp_count++;
    vpp_opened = true;//DTS2015071507006 modify by w00227189 20150718
    return 0;
ERROR_OPEN_DEVICE:
    //vpp_clk_disable(s_vpp_clk);
    regulator_bulk_disable(1, &vpp_regulator);
...
static int vpp_close(struct inode *inode, struct file *file)
{
    ...
    regulator_bulk_disable(1, &vpp_regulator);
    vpp_opened = false;//DTS2015071507006 modify by w00227189 20150718
    return 0;
}
...
#ifdef VPP_MMAP     //added by lwx215919 for DTS2015020303144 at 2015.02.03
//only for test
...
#endif  //added by lwx215919 for DTS2015020303144 at 2015.02.03
...
static struct file_operations vpp_file_ops =
{
    .open = vpp_open,
    .release = vpp_close,
    //modified by xwx271409 for DTS2015040902698 to update to Android 5.1 begin
#ifdef CONFIG_ARM64
    .compat_ioctl = vpp_ioctl,
#else
    .unlocked_ioctl = vpp_ioctl,
#endif
    //modified by xwx271409 for DTS2015040902698 to update to Android 5.1 end
#ifdef VPP_MMAP     //added by lwx215919 for DTS2015020303144 at 2015.02.03
    .mmap = vpp_mmap,
#endif  //added by lwx215919 for DTS2015020303144 at 2015.02.03
};
