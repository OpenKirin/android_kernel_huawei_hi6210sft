...
STATIC int32 hw_gnss_open(struct inode *inode, struct file *filp)
{
	...
	/* DTS2013112001862   Hi110x bug fix liuwenlong/00244150 2013/11/20 gegin */
...
STATIC int32 hw_gnss_release(struct inode *inode, struct file *filp)
{
	...
	/* DTS2013112001862   Hi110x bug fix liuwenlong/00244150 2013/11/20 begin */
    check_device_state(ps_core_d, GNSS_WRITE_FLAG);
    /* DTS2013112901567: Hi110x bug fix zwx144390 2013/11/29 begin */
    atomic_set(&ps_core_d->gnss_sleep_flag, 0);
    /* DTS2013112901567: Hi110x bug fix zwx144390 2013/11/29 end */
	/* DTS2013112001862   Hi110x bug fix liuwenlong/00244150 2013/11/20 end */
