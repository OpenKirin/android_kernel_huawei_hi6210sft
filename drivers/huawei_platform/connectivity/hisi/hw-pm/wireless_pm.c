...
/* DTS2013120205444 Hi110x bug fix l00225847 20131206 begin */
...
/* DTS2013120205444 Hi110x bug fix l00225847 20131206 end */
...
/*****************************************************************************
 * Prototype    : check_bt_state
 * Description  : check whether bt is power on or not
 * Input        : void
 * Output       : int32
 * Return       : 1 means power on,0 means power off
 * Calls        :
...
STATIC void bfg_hostwake_task(unsigned long data)
{
    ...
    {
        bfg_sleep_wakeup();
/* DTS2013112609153   Hi110x bug fix liuwenlong/00244150 2013/11/27 begin */
        if ((BT_STATE_BOOTUP == pm_data->bt_state) || (FM_STATE_BOOTUP == pm_data->fm_state))
        {
            pm_data->ps_pm_interface->reset_bt_timer(1);
        }
/* DTS2013112609153   Hi110x bug fix liuwenlong/00244150 2013/11/27 end */
        spin_unlock_bh(&pm_data->tx_lock);
