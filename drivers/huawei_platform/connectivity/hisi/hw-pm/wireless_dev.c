...
/*****************************************************************************
 * Prototype    : hsad_hi110x_get_gpio
 * Description  : get gpio form hsad (auto generate by *.xml)
 * Input        : void
 * Output       : no
 * Return       : void
 * Calls        :
...
/*****************************************************************************
 * Prototype    : sdio_irq_gpio_down
 * Description  : set sdio data and wakeup irq down, to fix bug of device 
 * Input        : void
 * Output       : no
 * Return       : void
 * Calls        :
...
/*****************************************************************************
 * Prototype    : output_32k_clk
 * Description  : output 32k clock for device 
 * Input        : void
 * Output       : no
 * Return       : void
 * Calls        :
...
/*****************************************************************************
 * Prototype    : set_uart_clk 
 * Description  : set uart clock to 150M
 * Input        : void
 * Output       : no
 * Return       : void
 * Calls        :
