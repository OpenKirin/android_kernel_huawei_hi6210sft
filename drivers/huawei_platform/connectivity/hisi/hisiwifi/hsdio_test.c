 ...
 *
 *
 * File Name     : hsdio_test.c
 * Version       : Initial Draft
 * Author        : hkf74032
 * Created       : 2012/8/24
 * Last Modified :
 * Description   : sdio test driver for hisilicon connectivity device
 * Function List :
 * History       :
 * 1.Date        : 2012/8/24
 *   Author      : hkf74032
...
/*DTS2014011800128   Hi110x bug fix zhouxinfeng/z00262551 2014/1/20 begin */
...
/*
 * Prototype    : hsdio_test_get_trans_time
 * Description  : get hsdio test trans time
 * Input        :
 * Output       :
...
/*
 * Prototype    : hsdio_test_result_report
 * Description  : report hsdio test result
 * Input        :
 * Output       :
 * Return Value : succ or fail
 * Calls        :
...
/*
 * Prototype    : hsdio_test_throughput_cac
 * Description  : statistic tx only throughput
 * Input        :
 * Output       :
 * Return Value : succ or fail
 * Calls        :
...
/*
 * Prototype    : hsdio_test_tx_throughput_statistic
 * Description  : statistic tx only throughput
 * Input        :
 * Output       :
 * Return Value : succ or fail
...
/*
 * Prototype    : hsdio_test_loop_throughput_statistic
 * Description  : statistic tx only throughput
 * Input        :
 * Output       :
 * Return Value : succ or fail
...
/*
 * Prototype    : hsdio_test_start
 * Description  : start test
 * Input        : uint8  test_type
 * Output       :
 * Return Value : succ or fail
 * Calls        :
 * Called By    :
...
/*DTS2014011800128   Hi110x bug fix zhouxinfeng/z00262551 2014/1/20 end */
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
