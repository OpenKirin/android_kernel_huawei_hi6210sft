 ...
 *
 *
 * File Name     : user_ctrl.c
 * Version       : Initial Draft
 * Author        : z00209041
 * Created       : 2012/11/27
 * Last Modified :
 * Description   : user ctrl the interface to set msglevel
 * Function List :
 * History       :
 * 1.Date        : 2012/11/27
 *   Author      : z00209041
...
/*
 * Prototype    : hwifi_get_loglevel
 * Description  : get the current msg level use cat commond
...
/*
 * Prototype    : hwifi_set_loglevel
 * Description  : set the current msg level use echo commond
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
                size_t count
...
/*
 * Prototype    : hwifi_get_coex_level
 * Description  : get the wifi work level
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
 * Output       : None
...
/*
 * Prototype    : hwifi_set_coex_level
 * Description  : set the wifi work level
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
                size_t count
...
/*
 * Prototype    : get_powermgmt_switch
 * Description  : get the current lower power status
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
 * Output       : None
...
/*
 * Prototype    : set_powermgmt_switch
 * Description  : set the current lower power status
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
                size_t count
...
/*
 * Prototype    : get_certify_powermode
 * Description  : get the current certify powermode
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
 * Output       : None
...
/*
 * Prototype    : set_certify_powermode
 * Description  : set the current certify power mode
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
                size_t count
...
/*
 * Prototype    : get_high_throughput_mode
 * Description  : get the current throughput mode
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
 * Output       : None
...
/*
 * Prototype    : set_high_throughput_mode
 * Description  : set the current high throughput mode
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
                size_t count
...
/*
 * Prototype    : get_normal_mode
 * Description  : get the current normal powermode
 * Input        : struct device *dev
 *   History        :
 *   1.Date         : 2013/9/23
 *     Author       : z00209041
...
/*
 * Prototype    : set_normal_mode
 * Description  : set the current normal power mode
 * Input        : struct device *dev
                struct device_attribute *attr
 *   History        :
 *   1.Date         : 2013/9/24
...
/*
 * Prototype    : get_cur_cpureq
 * Description  : get the current cpu freqency for HI1101
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
 * Output       : None
...
/*
 * Prototype    : set_cur_cpureq
 * Description  : set the current cpu requency of HI1101
 * Input        : struct device *dev
                struct device_attribute *attr
                char *buf
                size_t count
...
/*
 * Prototype    : get_40M_sdio_rate
 * Description  : get 40MHz cpu freq sdio rate
 * Input        : struct device *dev
                struct device_attribute *attr
 *   History        :
 *   1.Date         : 2013/9/17
...
/*
 * Prototype    : set_40M_sdio_rate
 * Description  : set 40MHz cpu freq sdio rate
 * Input        : struct device *dev
                struct device_attribute *attr
 *   History        :
 *   1.Date         : 2013/9/17
...
/*
 * Prototype    : get_80M_sdio_rate
 * Description  : get 80MHz cpu freq sdio rate
 * Input        : struct device *dev
                struct device_attribute *attr
 *   History        :
 *   1.Date         : 2013/9/17
...
/*
 * Prototype    : set_80M_sdio_rate
 * Description  : set 80MHz cpu freq sdio rate
 * Input        : struct device *dev
                struct device_attribute *attr
 *   History        :
 *   1.Date         : 2013/9/17
...
/*
 * Prototype    : get_160M_sdio_rate
 * Description  : get 160MHz cpu freq sdio rate
 *   History        :
 *   1.Date         : 2013/9/17
 *     Author       : z00209041
 *     Modification : Created function
...
/*
 * Prototype    : set_160M_sdio_rate
 * Description  : set 160MHz cpu freq sdio rate
 * Input        : struct device *dev
                  struct device_attribute *attr
 *   History        :
 *   1.Date         : 2013/9/17
...
/*
 * Prototype    : get_android_sleep_policy
 * Description  : get Android sleep policy
 *   History        :
 *   1.Date         : 2013/8/26
 *     Author       : z00209041
 *     Modification : Created function
...
/*
 * Prototype    : set_android_sleep_policy
 * Description  : set the current android sleep policy
 * Input        : struct device *dev
                struct device_attribute *attr
 *   History        :
 *   1.Date         : 2013/8/26
...
/*
 * Prototype    : get_watchdog_timeout
 * Description  : get the watchdog timeout
 *   History        :
 *   1.Date         : 2013/8/26
 *     Author       : z00209041
 *     Modification : Created function
...
/*
 * Prototype    : set_watchdog_timeout
 * Description  : set the current watchdog timeout
 * Input        : struct device *dev
                struct device_attribute *attr
 *   History        :
 *   1.Date         : 2013/8/26
...
STATIC ssize_t set_watchdog_timeout(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
    ...
    {
    /* DTS2013110501752   Hi110x bug fix 张华/z00209041 日期（2013年/11月/8日） start */
...
/*
 * Prototype    : get_flowctrl
 * Description  : get flowctrl
...
/*
 * Prototype    : set_flowctrl_on
 * Description  : set flowctrl on
 * Input        : struct device *dev, struct device_attribute *attr, const char *buf, size_t count
 * Output       : None
 * Return Value : int32
 * Calls        :
 * Called By    :
...
/*
 * Prototype    : get_packet_stats
 * Description  : get_packet_stats
 * Input        : struct device *dev, struct device_attribute *attr, char *buf
 * Output       : None
 * Return Value : uint32
 * Calls        :
