...
/*****************************************************************************
 *  Prototype    : get_ini_file_name
 *  Description  : read ini file name form sys
 *  Input        : void
 *  Output       :
 *
 *  Return Value : int8 *
...
static int32 ini_check_value(int8 *puc_value)
{
	...
	/* DTS2013112101671   Hi110x bug fix liuwenlong/00244150 2013/11/20 begin */
    /* check \n of line */
	if ('\n' == puc_value[l_len - 1])
    {
        puc_value[l_len - 1] = '\0';
	...
	/* DTS2013112101671   Hi110x bug fix liuwenlong/00244150 2013/11/20 end */
	return INI_SUCC;
}
...
#ifndef INI_KO_MODULE
/*****************************************************************************
 *  Prototype    : ini_write_mode_value
 *  Description  : write value to mode Variable 
 *  Input        : INI_FILE *fp, int32 modu, int8 * puc_var, int8 * puc_value
 *  Output       :
 *
 *  Return Value : int32
...
/*****************************************************************************
 *  Prototype    : ini_write_var_value
 *  Description  : write value to mode Variable 
 *  Input        : int32 modu, int8 * puc_var, int8 * puc_value
 *  Output       :
 *
 *  Return Value : int32
 *  Calls        :
