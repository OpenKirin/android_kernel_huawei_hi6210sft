 ...
 * Created       : 2013/6/9
 * Last Modified :
 * Description   : oam kernel for data interchange with driver 
 * Function List :
 * History       :
 * 1.Date        : 2013/6/9
 *   Author      : l00241925
...
/*
 * Prototype    : oamkernel_up_log
 * Description  : recv data from kernel driver
...
/*
 * Prototype    : oamkernel_up_mem_data
 * Description  : recv data from kernel driver
 * Input        : struct sk_buff *skb                 
 * Return Value : int32
 * Calls        :
...
/*
 * Prototype    : oamkernel_up_reg_data
 * Description  : recv data from kernel driver
 * Input        : struct sk_buff *skb                 
 * Return Value : int32
 * Calls        :
...
#ifdef SDT_OAM_FOR_1151
/*
 * Prototype    : oamkernel_send_data_to_driver
 * Description  : send data to driver
 * Input        : int8 main_type
                  int8 sub_type
                  uint8 *puc_data
                  int32 data_len
...
/*
 * Prototype    : wifi_free_skb
 * Description  : free skb buffer
 * Input        : struct sk_buff *skb
 * Output       : None
 * Return Value : struct sk_buff *
...
int32 oam_start(void)
{
	...
	#else
    /* DTS2013110510297: Hi110x bug fix zwx144390 2013/11/07 begin */
    ...
    /* DTS2013110510297: Hi110x bug fix zwx144390 2013/11/07 end */
    #endif
