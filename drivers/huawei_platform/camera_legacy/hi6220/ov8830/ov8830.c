...
#include <mach/gpio.h>
/* Modify by zkf78283 for power sensor, 2012/11.28, bigen */
#include <linux/gpio.h>
/* Modify by zkf78283 for power sensor, 2012/11.28, end */
...
/* AWB */
	...
	{0x1d8eb, 0x00}, //B gain for C indoor, changed by y00215412 DTS2012073002726 2012-08-06 for office yellowish.		//[diff] not found in  V1.3A  reserved in V1.0
	{0x1d8ec, 0x10},//R gain for C indoor									//[diff] not found in  V1.3A  reserved in V1.0            
	{0x1d8ed, 0xf8}, //B gain for D indoor, y00215412      //[diff] not found in  V1.3A  reserved in V1.0
...
/* Modify by zkf78283 for FPGA mipi rate, 2012.11.28, begin*/
#if 0
static framesize_s ov8830_framesizes[] = {
	...
	/* modified by c00168914 for DTS2012060705730 begin */
	/* 3264x1836 */
	...
	/* modified by c00168914 for DTS2012060705730 end */
};
#endif
/* Modify by zkf78283 for FPGA mipi rate, 2012.11.28, end */

/* Added by zkf78283 for MIPI rate 100Mbps/lane, 2012.12.18, begin */
static framesize_s ov8830_framesizes[] = {
	/* 1600x1200, just close with quarter size */
...
/* Added by zkf78283 for MIPI rate 100Mbps/lane, 2012.12.18, end */
...
{
	/* Added zkf78283 for write register of sensor, 2012/11.23, begin */
	msleep(10);
	/* Added zkf78283 for write register of sensor, 2012/11.23, end */
...
static int ov8830_framesize_switch(camera_state state)
{
	...
	/* Added by j00212990 DTS2012080602302 2012-08-05 for OV8830REG_TIMING_FORMAT1(0x3820) error. */
	msleep(3);
...
/*
 * Revised by y00231328 20121017 for DTS2012101201219, 20121229 for DTS2012122102699
 * if LED range is too wide and fix flash awb can not cover, so can use awb free go mode.
 * b_gain is LED0' b_gain, Gb_gain is LED0's r_gain;
 * Gr_gain is Led1's b_gain, r_gain is Led1's r_gain.
 */
...
#define R_GAIN_MAX	0x98 /* reduce max CCM R-pregain from 0xd0->0xb0 by y00215412 2012-1229. */
...
static int ov8830_init(void)
{
...
#if 0   /* del for B05X */
    /* Modify by zkf78283 for GPIO control power, 2012/11/22, begin */
    ...
    /* Modify by zkf78283 for GPIO control power, 2012/11/22, end */
#endif
...
void ov8830_update_otp_wb(u16 otp_index)
{
	...
	if(CT_hligt_d50_r_new > 0xff) {
		/* h00206029 delete it for AWB green 2012-07-05 */
	...
	*/
	...
	/* Revised by y00231328 20121017 for DTS2012101201219 start */
	...
	/* Revised by y00231328 20121017 for DTS2012101201219 end */
...
static void ov8830_set_default(void)
{
	/* add by c00168914 for CS_CHIP/ES_CHIP begin */
	unsigned int chip_id;
	int i;
	/* add by c00168914 for CS_CHIP/ES_CHIP end */
	...
	/* added by y00231328 for awb settings change with CCM pre-gain 2012-11-1. */
