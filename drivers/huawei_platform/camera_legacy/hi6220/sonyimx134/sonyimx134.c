...
#define _IS_DEBUG_AE 0	//add by z00221179 for dubeg 2013/4/24
...
extern int k3_ispio_read_seq(i2c_index_t index,u8 i2c_addr,struct _sensor_reg_t *seq,u32 size,i2c_length length);//add by z00221179
 ...
 /* BEGIN: Modified by w00199382, 2013/7/6   for:DTS2013070103078*/
static camera_capability sonyimx134_cap[] = {
 ...
 /* END:odified by w00199382, 2013/7/6   for:DTS2013070103078*/
...
/*Modified  by z00221179, 2013/04/23, start */
//1280x720
...
//3264x1840:add by c00144034,change from 3264x2448
				 ...
				 struct v4l2_frmsize_discrete *fs, int flag, camera_setting_view_type view_type,bool zsl_preview,camera_b_shutter_mode b_shutter_mode,ecgc_support_type_s ecgc_type)
{
	...
	/*detele by z00221179 for hdr_movie 2013/4/24 start */
	#if 0
		...
		#endif
		/*detele by z00221179 for hdr_movie 2013/4/24 end */
...
/*detele by z00221179 for hdr_movie and lowlight 2013/4/24 start */
#if 0
	if( HDR_MOVIE_ON== sonyimx134_sensor.hdrInfo.hdr_on)
	{
 ...
 **************************************************************************
*/
/*detele by z00221179 for lowlight 2013/4/24 start */
#if 0
/* < zhoutian 00195335 2013-03-02 added for SuperZoom-LowLight begin */
...
static int sonyimx134_init_reg(void)
{
    ...
    /* change rgb type for dts2013082005877 by c00220250*/
...
static int sonyimx134_update_flip(u16 width, u16 height)
{
	...
	if(sonyimx134_sensor.old_flip != new_flip) {
        ...
        /* change flip&mirror for dts2013082005877 by c00220250*/
        ...
        /* < zhoupengtao 00124583 move for cut the 13M camera capture Interval begin */
		//msleep(200);
		/* zhoupengtao 00124583 move for cut the 13M camera capture Interval end > */
	}
	return 0;
}
...
* Other       : NA;
***************************************************************************/
/*delete by z00221179 for hdr_movie 2013/4/24 start*/
#if 0
...
#endif
/*delete by z00221179 for hdr_movie 2013/4/24 end*/
 ...
 **************************************************************************
*/
/*delete by z00221179 for hdr_moive 2013/4/23 start*/
#if 0
...
static void sonyimx134_set_default(void)
{
	...
	/* zhoutian 00195335 2013-03-02 added for SuperZoom-LowLight end > */
#endif
/*detele by z00221179 for lowlight 2013/4/24 end */
