/* <DTS2013011103140 yuhaitao 20130111 begin */
/*
...
/* De-noise */
	...
	{0x65523, 0x02},//DTS2012121206572 from 0x00->0x02
	{0x65524, 0x00},
	{0x65525, 0x04},//DTS2012121206572 from 0x03->0x04
	{0x65526, 0x00},
	{0x65527, 0x08},
	{0x65528, 0x00},
	{0x65529, 0x10},
...
/* AWB */
	...
	{0x1ccd1, 0x00}, //B gain for C indoor, changed by y00215412 DTS2012073002726 2012-08-06 for office yellowish.
...
/* Color matrix */
	...
	{0x1d8dd, 0xf0}, //Br thres0, y00215412 change for 30fps preview
	{0x1d8de, 0x44}, //Br thres1, y00215412 change for 30fps preview
	{0x1d8df, 0x34}, //Br thres1, y00215412 change for 30fps preview
...
/* AWB */
	...
	{0x1ccd1, 0x18}, //B gain for C indoor, changed by y00215412 DTS2012073002726 2012-08-06 for office yellowish.
...
/* <DTS2013020801141 yuhaitao 20130208 begin */
/*the framesize should be sorted by size, so must be modified in furture*/
/* <DTS2013022203668 yuhaitao 20130301 begin */
...
/* DTS2013022203668 yuhaitao 20130301 end> */
/* DTS2013020801141 yuhaitao 20130208 end> */
...
/* <DTS2013020603959 yuhaitao 20130206 begin */
/* <DTS2013022203668 yuhaitao 20130301 begin */
...
/* DTS2013022203668 yuhaitao 20130301 end> */
/* DTS2013020603959 yuhaitao 20130206 end> */
...
/* <DTS2013020801141 yuhaitao 20130208 begin */
	/* Added by j00212990 DTS2012080602302 2012-08-05 for OV8850REG_TIMING_FORMAT1(0x3820) error. */
	msleep(3);
...
static void ov8850_set_default(void)
{
	...
	/* <DTS2013020501810 Zhangbo 20130226 begin */
	strcpy(ov8850_sensor.info.name,"23060108FA-OV-F");
	/* DTS2013020501810 Zhangbo 20130206 end> */
/* <DTS2013020801141 yuhaitao 20130208 begin */
	ov8850_sensor.lane_clk = CLK_800M;	//CLK_800M
/* DTS2013020801141 yuhaitao 20130208 end> */
	/* add by c00168914 for CS_CHIP/DI_CHIP begin */
	chip_id = get_chipid();
...
MODULE_LICENSE("GPL");
/********************************** END **********************************************/
/* DTS2013011103140 yuhaitao 20130111 end> */
