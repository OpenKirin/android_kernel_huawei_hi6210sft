...
{
    unsigned int     guWaterMark;    /* SOCP编码目的通道数据传输水线，GU通道 */
    unsigned int     lWaterMark;     /* SOCP编码目的通道数据传输水线，L通道 */
    unsigned int     overTime;       /* SOCP编码目的通道数据传输超时时间 */
    unsigned int     flushFlag;      /* SOCP编码目的通道数据立即输出标志 */
...
*****************************************************************************/
unsigned int mdrv_socp_get_sd_logcfg(unsigned int *pulEnable, unsigned int *pulTimerLen, unsigned int *pulBufferSize);
/*****************************************************************************
