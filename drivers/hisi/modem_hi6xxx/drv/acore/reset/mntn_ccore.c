...
/*****************************************************************************
 Description : delcare mntn notifier call especially the shell cmd to run
                    register into reset management module ,for example
                    modem_panic_notifier_call
                    modem_panic_notifer_block
                    modem_panic_mntn_init, in this function ,register notifier block
  History
  1.Date: 2012/9/13
    Author : x00138766
  ...
  2.Date: 2013/8/26
    modifier: yuanfang 00241633
    DEEP_SLEEP_FOR_LOG DTS:2013081800468
*****************************************************************************/
...
/*****************************************************************************
 Description :  modem panic, modem freeze
  History
  1.Date: 2012/9/13
    Author : x00138766
    Modification : Created function
