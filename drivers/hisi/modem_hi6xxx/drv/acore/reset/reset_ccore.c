...
/* BEGIN: Modified by y65256 for DTS2013100801865, 2013/10/21 */
...
/* END:   Modified by y65256 for DTS2013100801865, 2013/10/21 */
...
/* BEGIN: Modified by y65256 for DTS2013061404451, 2013/6/20 */
...
/* END:   Modified by y65256 for DTS2013061404451, 2013/6/20 */
...
/*****************************************************************************
 Description : register modem reset cpu notifier to work queue,
  History
  1.Date: 2013/9/16
    Author : z00212992
    Modification : Created function
                   y65256 for DTS2013100801865 2013/10/21
*****************************************************************************/
...
/*****************************************************************************
 Description : modem freeze irq handle ,to launch modem_freeze work queue,
  History
  1.Date: 2012/9/13
    Author : x00138766
    Modification : Created function
...
#endif
/*****************************************************************************
 Description : modem panic irq handle ,to launch modem_panic work queue,
  History
  1.Date: 2012/9/13
    Author : x00138766
    Modification : Created function
...
static void modem_panic_irq(unsigned int param)
{
    ...
    /*DTS2014070707585,delay to save log*/
...
/*****************************************************************************
 Description : modem reboot irq handle ,to launch normal reboot work queue,
  History
  1.Date: 2012/9/13
    Author : x00138766
    Modification : Created function
