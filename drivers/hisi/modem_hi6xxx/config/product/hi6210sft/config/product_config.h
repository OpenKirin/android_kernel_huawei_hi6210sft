/* MD5: 480b7dbe4ca401ecd2d2856c5922eac9*/
...
#define PRODUCT_CFG_VERSION_STR "V800R100C51B190" 
#endif 

#ifndef PRODUCT_FULL_VERSION_STR
#define PRODUCT_FULL_VERSION_STR "Balong V800R100C51B190" 
#endif 
...
#define LPHY_TOTAL_IMG_SIZE		 ((LPHY_PUB_DTCM_SIZE)+(LPHY_PUB_ITCM_SIZE)+(LPHY_PRV_DTCM_SIZE)*3+(LPHY_PRV_ITCM_SIZE)*3) 
#endif 
...
#define MCORE_COMPONENTS			 bsp_ccore.o gumsp_mcore.o nas_ccore.o rabm_ccore.o gas_ccore.o was_ccore.o ttf_ccore.o ascomm_ccore.o pscomm_ccore.o taf_ccore.o tlnas_ccore.o tlas_ccore.o lmsp_ccore.o gudsp_mcore.o gudsp_comm_RT.o gudsp_mcore_RT.o  modemcore1_union.o os_ccore.o 
#endif 

#ifndef RTOSCK_MCORE_COMPONENTS
#define RTOSCK_MCORE_COMPONENTS bsp_ccore.o gumsp_mcore.o nas_ccore.o rabm_ccore.o gas_ccore.o was_ccore.o ttf_ccore.o ascomm_ccore.o pscomm_ccore.o taf_ccore.o tlnas_ccore.o tlas_ccore.o lmsp_ccore.o gudsp_mcore.o gudsp_comm_RT.o gudsp_mcore_RT.o  modemcore1_union.o 
#endif 
