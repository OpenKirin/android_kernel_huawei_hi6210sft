...
/* DTS2014120808464 z00185430 20141128 modify for Carrera & Grace, begin */
...
struct hisi_sim_hotplug_info {
	...
	/*DTS2014090100023 j00172194 add begin*/
	...
	/*DTS2014090100023 j00172194 add end*/
	/* DTS2014120808464 z00185430 20141128 modify for Carrera & Grace, begin */
	int old_det_gpio_state;
	u32 card_tray;
	u32 hpd_trigger;
	u32 debounce_settings;
	/* DTS2014120808464 z00185430 20141128 modify for Carrera & Grace, end */
...
/* DTS2015052907214 w00180399 20150602 begin */
struct
{
...
/* DTS2015052907214 w00180399 20150602 end */
...
/* DTS2015030909513 z00185430 20150310 add begin */
...
/* DTS2015030909513 z00185430 20150310 add end */
...
static void set_sim_status(struct hisi_sim_hotplug_info *info, u32 sim_no, u32 sim_status, u32 trace, u32 notify)
{
	...
	/* DTS2014071504461 z00185430 20140726 modify begin */
	pr_info("sim%d set:%d det_level:%d\n", sim_no, sim_status, log_temp.det_level);
	/* DTS2014071504461 z00185430 20140726 modify end */
}
...
/*DTS2015012906022 z00185430 sim hotplug for A&C CORE begin*/
...
/*DTS2015012906022 z00185430 sim hotplug for A&C CORE end*/
...
static int sim_hotplug_dt_init(struct hisi_sim_hotplug_info *info, struct device_node *np, struct device *dev)
{
	...
	/* DTS2014071504461 z00185430 20140729 add begin */
	...
	/* DTS2014071504461 z00185430 20140729 add end */
...
static int hisi_sim_hotplug_probe(struct platform_device *pdev)
{
    ...
    /* DTS2014112705326  j00172194 add pmu start*/
    ...
    sim_pmu_hpd_read();
    /* DTS2014112705326  j00172194 add pmu end*/
	...
	/* DTS2015030601099 z00185430 add 20150310 begin */
	if (0 == info->sim_id) {
		sys_add_sim_node();
	}
	/* DTS2015030601099 z00185430 add 20150310 end */
