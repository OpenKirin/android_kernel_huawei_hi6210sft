...
/* DTS2015110305037 jiweifeng/jwx206032 2015-11-03 begin */
static char *g_reboot_reason[EXCH_S_MAX] = {"DIE",
											...
											"CSI1",
											"OTHERS"};
/* DTS2015110305037 jiweifeng/jwx206032 2015-11-03 end */
...
static unsigned int get_pid_ppid_of_task(struct task_struct * ptask)
{
    ...
    if (NULL != ptask && NULL != ptask->real_parent)
    {
...
static void exch_rtc_time_to_string(struct rtc_time *exc_tm, char *rtc_str)
{
    ...
    if (NULL == exc_tm || NULL == rtc_str) {
        printk("exc_tm or rtc_str is NULL\n");
        return;
    }
...
void systemError(int modId, int arg1, int arg2, char *arg3, int arg3Length)
{
    ...
    /* DTS2012110504193 begin */
    if (1 == g_pExchRoot->share_value.is_rebooting)
    {
        /* A核已经进入重启状态，直接返回 */
        return;
    }
    /* DTS2012110504193 end */

    /* DTS2013010704090 lkf71598 2013-01-16 begin */
    ...
    /* DTS2013010704090 lkf71598 2013-01-16 end */
...
static int __init exch_entry(void)
{
    ...
    /* DTS2013031902720 lkf71598 2013-03-19 */
...
/*DTS2014072600890 j00207786 begin*/
/*防止异常发生时，循环dabt破坏现场*/
...
/*DTS2014072600890 j00207786 end*/
...
/* DTS2012082706069 lkf71598 2012-12-25 begin */
...
/* DTS2012082706069 lkf71598 2012-12-25 end */
