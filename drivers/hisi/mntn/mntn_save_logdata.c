...
void mntn_rm_old_log(const char *ppath, unsigned int unumber)
{
    ...
    if (NULL == ppath)
    {
        MNTN_FILESYS_PRINT(KERN_ERR"mntn_err: ppath is NULL\n");    
        return;
    }
...
int mntn_mdm_reset_save_log(const char *preason)
{
    ...
    /* DTS2016042100919 lengjing 00278256 20160421 begin*/
    ...
    /* DTS2016042100919 lengjing 00278256 20160421 end*/
