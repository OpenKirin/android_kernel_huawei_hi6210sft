...
typedef long long (*call_ptr_with_str)(char* arg_str1, long long arg1, long long arg2, long long arg3, long long arg4, long long arg5, long long arg6);
typedef long long (*call_ptr)(long long arg1, long long arg2, long long arg3, long long arg4, long long arg5, long long arg6);

static struct tty_driver *shell_tty_drv;
static struct tty_port shell_tty_port;
static long long shell_call(char* func_name, char* arg_str1, long long arg1, long long arg2, long long arg3, long long arg4, long long arg5, long long arg6);
...
{
    long long *t = &dbg_value_for_ecall;
	printk("t = 0x%pK\n", t);
}
void reg_dbg_dump(unsigned long long pAddr, unsigned long long size, unsigned long long nodesize)
{
    ...
    if (((nodesize != sizeof(char))&&(nodesize != sizeof(short))
        ...
        printk("dump type should be 1(char),2(short),4(int),8(long long)\n");
        return;
    }
...
static int shell_ioctl(struct tty_struct *tty, unsigned int cmd, unsigned long arg)
{
	...
	case ES_TTY_IOCTL_CALL:
		...
		{
		ret = strncpy_from_user(temp_call_arg.arg_str1, call_arg->arg_str1, len);
		if (ret >= len)
		{
			printk("%s: strncpy_from_user fail, too long!\n", __FUNCTION__);
			kfree(temp_call_arg.func_name);
...
static long shell_compact_ioctl(struct tty_struct *tty, unsigned int cmd, unsigned long arg)
{
	...
	case ES_TTY_IOCTL_CALL:
		...
		ret = strncpy_from_user(func_name, (const char __user*)user_func, len);
		if (ret >= len)
		{
			kfree(func_name);
			printk("%s: strncpy_from_user fail, too long!\n", __FUNCTION__);
...
static int shell_init(void ) //clean warning
{
...
static long long shell_call(char* func_name, char* arg_str1, long long arg1, long long arg2, long long arg3, long long arg4, long long arg5, long long arg6)
{
    ...
    {
	    printk("input parameter: arg1=%llx,arg2=%llx,arg3=%llx,arg4=%llx,arg5=%llx,arg6=%llx\n", arg1,arg2,arg3,arg4,arg5,arg6);
        if (arg_str1)
        {
            printk("arg_str1 = %s\n", arg_str1);
			address_with_str = (call_ptr_with_str) kallsyms_lookup_name(func_name);
			if (!address_with_str)
    		    goto call_no_symbol;
			result = address_with_str(arg_str1, arg1, arg2, arg3, arg4, arg5, arg6);
        }
        else
        {
