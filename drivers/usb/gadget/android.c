...
/*DTS:DTS2013080504353 l00134988 2013-08-20 begin*/
#define USB_DEVIEC_PLUGIN  1
#define USB_DEVIEC_PLUGOUT 2
/*DTS:DTS2013080504353 l00134988 2013-08-20 end*/
#define USB_REQ_SEND_HOST_TIME    0xA2
/* BEGIN PN:DTS2014060501595, Added by s00258714, 2014/6/5 */
#define USB_DEVICE_BCD_CODE 0x9999
/* END PN:DTS2014060501595, Added by s00258714, 2014/6/5 */
...
/* BEGIN PN:DTS2014060501595, Modified by s00258714, 2014/6/5 */
    device_desc.bcdDevice = cpu_to_le16(USB_DEVICE_BCD_CODE);
/* END PN:DTS2014060501595, Modified by s00258714, 2014/6/5 */
...
/*BEGIN PN:DTS2015041704092, Added by s00258714, 2015/5/12*/
	err = hw_rwswitch_create_device(dev->dev,android_class);
    if (err) {
        pr_err("%s: failed to create android device %d", __func__, err);
        goto err_create;
    }
/*END PN:DTS2015041704092, Added by s00258714, 2015/5/12*/
    dev->disabled = 0;
    _android_dev = dev;
/*BEGIN PN:DTS2015041704092, Added by s00258714, 2015/5/12*/
