	...
	for (i = 0; i < HI6421_IRQ_ARRAY; i++) {
		...
		if (HI6421_IRQ_HPD_NUM == i) {
			if((pending & HI6421_IRQ_HPD0_VALUE)) {
				...
				/*close ldo11*/
				hi6421_pmic_sim_hpd_msg_to_ccore(SIM0); /*DTS2015012906022 z00185430 sim hotplug for A&C CORE*/
			...
			if ((pending & HI6421_IRQ_HPD1_VALUE)) {
				...
				/*close ldo12*/
				hi6421_pmic_sim_hpd_msg_to_ccore(SIM1); /*DTS2015012906022 z00185430 sim hotplug for A&C CORE*/
