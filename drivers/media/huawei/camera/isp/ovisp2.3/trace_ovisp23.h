...
TRACE_EVENT(hw_ovisp23_irq_handler_entry,
...
DECLARE_EVENT_CLASS(hw_ovisp23_write_internel,
...
TRACE_EVENT(hw_ovisp23_cmd_ready,
...
DECLARE_EVENT_CLASS(hw_ovisp23_event_internel,
