...
int mini_ispv1_focus_init(void)
{
	...
	sema_init(&(mini_afae_ctrl->af_run_sem), 1); /* added for DTS2013041904698 by j00212990 2013-04-26 */
...
static bool ispv1_copy_preview_data(u8 *dest, mini_camera_rect_s *rect)
{
	...
	if (NULL == dest || NULL == currframe) {
		print_error("params error, dest 0x%pK, frame 0x%pK", (void*)dest, (void*)currframe);
		goto error_out1;
	}

	if ((0 == currframe->phyaddr) || (NULL != currframe->viraddr)) {
		print_error("params error, frame->phyaddr 0x%pK, frame->viraddr:0x%pK",
			(void*)currframe->phyaddr, currframe->viraddr);
		goto error_out1;
	}
...
static bool analysis_contrast_value(u32 *array, mini_af_run_param *af_info)
{
	...
	/*< DTS2013092901239 removed by z00195335(w00223743) 2013-09-29 begin */
#if 0
	/*< DTS2013082004832 added by z00195335(w00223743) 2013-08-20 begin */
	else {
		for (index = 0; index < array_size; index++) {
	...
	/* DTS2013082004832 added by z00195335(w00223743) 2013-08-20 end >*/
#endif
	/* DTS2013092901239 removed by z00195335(w00223743) 2013-09-29 end >*/
...
static void ispv1_k3focus_run(void)
{
	...
	/*< DTS2013092901239 moved backward by z00195335(w00223743) 2013-09-29 begin */
	/* init params */
	sema_init(&sem_af_schedule, 0);
	/* DTS2013092901239 moved backward by z00195335(w00223743) 2013-09-29 end >*/
