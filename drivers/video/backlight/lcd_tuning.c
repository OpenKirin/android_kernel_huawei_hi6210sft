 ...
 *
 */
/*< DTS2014063002494, Added by z00248697. Add color temperature feature. 2014/06/30 begin */
...
/*BEGIN PN:DTS2014080200942, Modified by z00248697. 2014/08/08 */
#include "../hisi/hi6220/ade_cmdqueue.h"
/*END PN:DTS2014080200942,  Modified by y00248697. 2014/08/08 */
#define PRIMARY_LCD "pri_lcd"
/* BEGIN PN:DTS2014071107583  , Modified by z00248697, 2014/07/12*/
...
static int set_color_temperature(struct lcd_tuning_dev *ltd, unsigned int csc_value[])
{
	...
	/* BEGIN DTS2014080200942, Deleted by z00248697, 2014/08/08*/
	/* END   DTS2014080200942, Deleted by z00248697, 2014/08/08*/
	down(&g_ct_sem);
	for (i = 0; i < 9; i++)
	{
...
/* END PN:DTS2014071107583  , Modified by z00248697, 2014/07/12*/
...
/* BEGIN DTS2014080200942, Modified by z00248697, 2014/08/08*/
    pr_info(" Enter %s successful !",__func__);
	ltd = &lmdev->ltd;
...
/* END   DTS2014080200942, Modified by z00248697, 2014/08/08*/
...
/* DTS2014063002494, Added by z00248697. Add color temperature feature. 2014/06/30 end> */
